...
export default function Organization() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const updatedOrganizations = {
      ...
      organizationIcon: selectedFile,
    };
    console.log("Org Data", updatedOrganizations)

    try {
      fnOrg(updatedOrganizations);
      console.log("Organizations updated:", user);
      router.push("/tasks");
    } catch (error) {
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <Card className="bg-gray-900/80 backdrop-blur-sm border-gray-800 p-6 mb-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="orgIcon" className="block text-lg font-bold mb-2 text-blue-400">
                    Organization Icon
                  </label>
                  <Input
                    id="orgIcon"
